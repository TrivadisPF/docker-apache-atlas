...
RUN mv /tmp/atlas-src/distro/target/apache-atlas-*-bin.tar.gz /apache-atlas.tar.gz \
	&& mv /tmp/atlas-src/distro/target/apache-atlas-*-kafka-hook.tar.gz /apache-atlas-kafka-hook.tar.gz \
	&& mv /tmp/atlas-src/distro/target/apache-atlas-*-hive-hook.tar.gz /apache-atlas-hive-hook.tar.gz \
	&& mv /tmp/atlas-src/distro/target/apache-atlas-*-sqoop-hook.tar.gz /apache-atlas-sqoop-hook.tar.gz
